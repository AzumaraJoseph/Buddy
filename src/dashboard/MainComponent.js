                ...
                <div className="watchlist">
                    <div className="growth">
                        ...
                        <div className="growth-chart">
                            {/* <div style={{ height: '72px', width: '96px' }}> */}
                                <div style={{ height: '72px', width: '96px', marginRight: '10px' }}>
                                    ...
                                    <div style={{ height: '40px', width: '57px' }}>
                                        <p style={{ fontFamily: 'lexend', fontSize: '15px', fontWeight: '500', color: '#A3A3A6', margin: '0' }}>$142.90</p>
                                        <p style={{ fontFamily: 'lexend', fontSize: '12px', fontWeight: '500', color: '#00A441', width: '42px', margin: '0' }}>0.47%</p>
                                    </div>
                                </div>
                        ...
                        <div className="growth-chart">
                            <div style={{ height: '72px', width: '96px', marginRight: '10px' }}>
                                <div className="growth-details">
                                    <h2>BPL</h2>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.3552 11.6421L17.3552 11.6421L17.3581 11.645C17.405 11.6915 17.4421 11.7468 17.4675 11.8077C17.4929 11.8686 17.506 11.934 17.506 12C17.506 12.066 17.4929 12.1314 17.4675 12.1923C17.4421 12.2532 17.405 12.3085 17.3581 12.355L17.3566 12.3564L12.3612 17.3519C12.3143 17.396 12.2594 17.4306 12.1994 17.4538L12.1886 17.458L12.1781 17.4627C12.122 17.4874 12.0614 17.5002 12.0002 17.5002C11.9389 17.5002 11.8783 17.4874 11.8223 17.4627L11.8117 17.458L11.8009 17.4538C11.741 17.4306 11.6861 17.396 11.6392 17.3519L6.64374 12.3564C6.5492 12.2619 6.49609 12.1337 6.49609 12C6.49609 11.8663 6.5492 11.7381 6.64374 11.6436C6.73827 11.549 6.86649 11.4959 7.00019 11.4959C7.1338 11.4959 7.26195 11.549 7.35647 11.6434C7.35653 11.6434 7.35658 11.6435 7.35663 11.6436L10.6461 14.943L11.5002 15.7997V14.59V7C11.5002 6.86739 11.5529 6.74022 11.6466 6.64645C11.7404 6.55268 11.8676 6.5 12.0002 6.5C12.1328 6.5 12.26 6.55268 12.3537 6.64645C12.4475 6.74022 12.5002 6.86739 12.5002 7V14.59V15.7997L13.3543 14.943L16.6443 11.643L16.6452 11.6421C16.6917 11.5952 16.747 11.558 16.8079 11.5327C16.8688 11.5073 16.9342 11.4942 17.0002 11.4942C17.0662 11.4942 17.1315 11.5073 17.1925 11.5327C17.2534 11.558 17.3087 11.5952 17.3552 11.6421Z" fill="#3B3B45" stroke="#FF5252"/>
                                    </svg>
                                ...
                                <div style={{ height: '40px', width: '57px' }}>
                                    <p style={{ fontFamily: 'lexend', fontSize: '15px', fontWeight: '500', color: '#A3A3A6', margin: '0' }}>$142.90</p>
                                    <p style={{ fontFamily: 'lexend', fontSize: '12px', fontWeight: '500', color: '#FF5252', width: '42px', margin: '0' }}>-0.78%</p>
                                </div>
                            </div>
                            <svg width="155" height="60" viewBox="0 0 155 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line x1="1" y1="33" x2="155" y2="33" stroke="#D1D1D3" stroke-dasharray="5 5"/>
                    ...
                    <div className="revenue">
                        <h2 style={{ fontFamily: 'lexend', fontSize: '20px', fontWeight: '700', color: '#3B3B45', margin: '0 0 10px 0' }}>Revenue</h2>
                        <div>
                            <div className="revenue-count">
                                <div style={{ height: '40px', width: '133px' }}>
                                    <h2 style={{ margin: '0', fontFamily: 'lexend', fontSize: '18px', fontWeight: '600', color: '#3B3B45' }}>$4,000</h2>
                                    <p style={{ margin: '0', fontFamily: 'lexend', fontSize: '12px', fontWeight: '400', color: '#A3A3A6' }}>Recenty added pages</p>
                                </div>
                                <div style={{ height: '42px', width: '42px', backgroundColor: '#1773EA14', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '100px' }}>
                                    <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.6 4.43332H14.1666V1.78332C13.4081 1.70444 12.6459 1.6655 11.8833 1.66665C9.61663 1.66665 8.06663 3.04998 8.06663 5.58332V7.76665H5.5083V10.7333H8.06663V18.3333H11.1333V10.7333H13.6833L14.0666 7.76665H11.1333V5.87498C11.1333 4.99998 11.3666 4.43332 12.6 4.43332Z" fill="#1773EA"/>
                                    </svg>
                                </div>
                            ...
                            <div className="revenue-count">
                                <div style={{ height: '40px', width: '133px' }}>
                                    <h2 style={{ margin: '0', fontFamily: 'lexend', fontSize: '18px', fontWeight: '600', color: '#3B3B45' }}>$2,120</h2>
                                    <p style={{ margin: '0', fontFamily: 'lexend', fontSize: '12px', fontWeight: '400', color: '#A3A3A6' }}>Video Monetization</p>
                                </div>
                                <div style={{ height: '42px', width: '42px', backgroundColor: '#EB334814', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '100px' }}>
                                <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.4498 4.55002C14.2521 4.55002 14.0587 4.60867 13.8943 4.71855C13.7298 4.82843 13.6016 4.98461 13.526 5.16734C13.4503 5.35006 13.4305 5.55113 13.4691 5.74511C13.5076 5.93909 13.6029 6.11727 13.7427 6.25713C13.8826 6.39698 14.0608 6.49222 14.2547 6.53081C14.4487 6.56939 14.6498 6.54959 14.8325 6.4739C15.0152 6.39821 15.1714 6.27004 15.2813 6.10559C15.3912 5.94114 15.4498 5.7478 15.4498 5.55002C15.4498 5.2848 15.3445 5.03045 15.1569 4.84291C14.9694 4.65538 14.7151 4.55002 14.4498 4.55002ZM18.2832 6.56669C18.267 5.87527 18.1375 5.19119 17.8998 4.54169C17.6879 3.98596 17.3582 3.48275 16.9332 3.06669C16.5205 2.63954 16.0161 2.31183 15.4582 2.10835C14.8104 1.86349 14.1255 1.73103 13.4332 1.71669C12.5498 1.66669 12.2665 1.66669 9.99984 1.66669C7.73317 1.66669 7.44984 1.66669 6.5665 1.71669C5.87413 1.73103 5.18929 1.86349 4.5415 2.10835C3.98457 2.31389 3.48062 2.64132 3.0665 3.06669C2.63936 3.47934 2.31165 3.98372 2.10817 4.54169C1.8633 5.18947 1.73085 5.87431 1.7165 6.56669C1.6665 7.45002 1.6665 7.73335 1.6665 10C1.6665 12.2667 1.6665 12.55 1.7165 13.4334C1.73085 14.1257 1.8633 14.8106 2.10817 15.4584C2.31165 16.0163 2.63936 16.5207 3.0665 16.9334C3.48062 17.3587 3.98457 17.6861 4.5415 17.8917C5.18929 18.1366 5.87413 18.269 6.5665 18.2834C7.44984 18.3334 7.73317 18.3334 9.99984 18.3334C12.2665 18.3334 12.5498 18.3334 13.4332 18.2834C14.1255 18.269 
                                </svg>
                            ...
                            <div className="revenue-count">
                                <div style={{ height: '40px', width: '133px' }}>
                                    <h2 style={{ margin: '0', fontFamily: 'lexend', fontSize: '18px', fontWeight: '600', color: '#3B3B45' }}>$1,752</h2>
                                    <p style={{ margin: '0', fontFamily: 'lexend', fontSize: '12px', fontWeight: '400', color: '#A3A3A6' }}>Community Buildup</p>
                                </div>
                                <div style={{ height: '42px', width: '42px', backgroundColor: '#2764AC14', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '100px' }}>
                                <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.0585 1.66668H2.9418C2.78311 1.66448 2.62555 1.69355 2.4781 1.75225C2.33066 1.81095 2.19622 1.89812 2.08246 2.00877C1.96871 2.11943 1.87786 2.25142 1.81512 2.39719C1.75238 2.54296 1.71897 2.69966 1.7168 2.85835V17.1417C1.71897 17.3004 1.75238 17.4571 1.81512 17.6028C1.87786 17.7486 1.96871 17.8806 2.08246 17.9913C2.19622 18.1019 2.33066 18.1891 2.4781 18.2478C2.62555 18.3065 2.78311 18.3356 2.9418 18.3333H17.0585C17.2171 18.3356 17.3747 18.3065 17.5222 18.2478C17.6696 18.1891 17.804 18.1019 17.9178 17.9913C18.0316 17.8806 18.1224 17.7486 18.1851 17.6028C18.2479 17.4571 18.2813 17.3004 18.2835 17.1417V2.85835C18.2813 2.69966 18.2479 2.54296 18.1851 2.39719C18.1224 2.25142 18.0316 2.11943 17.9178 2.00877C17.804 1.89812 17.6696 1.81095 17.5222 1.75225C17.3747 1.69355 17.2171 1.66448 17.0585 1.66668ZM6.7418 15.6167H4.2418V8.11668H6.7418V15.6167ZM5.4918 7.06668C5.14702 7.06668 4.81636 6.92972 4.57256 6.68592C4.32876 6.44212 4.1918 6.11146 4.1918 5.76668C4.1918 5.4219 4.32876 5.09124 4.57256 4.84744C4.81636 4.60365 5.14702 4.46668 5.4918 4.46668C5.67488 4.44592 5.86028 4.46406 6.03586 4.51992C6.21144 4.57578 6.37325 4.66809 6.51068 4.79082C6.64811 4.91354 6.75807 5.06391 6.83336 5.23208C6.90864 5.40025 6.94756 5.58243 6.94756 5.76668C6.94756 5.95093 6.90864 6.13311 6.83336 6.30128C6.75807 6.46945 6.64811 6.61982 6.51068 6.74255C6.37325 6.86527 6.21144 6.95759 6.03586 7.01345C5.86028 7.0693 5.67488 7.08744 5.4918 7.06668ZM15.7585 15.6167H13.2585V11.5917C13.2585 10.5833 12.9001 9.92502 11.9918 9.92502C11.7107 9.92707 11.437 10.0152 11.2075 10.1777C10.978 10.3401 10.8039 10.5689 10.7085 10.8333C10.6433 11.0292 10.615 11.2355 10.6251 11.4417V15.6083H8.12513C8.12513 15.6083 8.12513 8.79168 8.12513 8.10835H10.6251V9.16668C10.8522 8.7726 11.1826 8.44795 11.5805 8.22768C11.9784 8.00742 12.4289 7.89989 12.8835 7.91668C14.5501 7.91668 15.7585 8.99168 15.7585 11.3V15.6167Z" fill="#2764AC"/>
                                </svg>
